...
const ReceiveTheDeathFileAccordion = ({handleGetNationalId, handleGetFullName, handleGetContractNumber}) => {
    ...
    const [contractNumberRes, setContractNumberRes] = useState();
                                ...
                                <CardBody>
                                    <Form className="needs-validation" noValidate="">
                                        <Row>
                                            ...
                                            <Col md="3 mb-3">
                                                <input className="form-control input-air-primary" name="lastName" type="number" placeholder="شماره قرارداد"
                                                   onChange={e => setContractNumberRes(e.target.value)}
                                                   value={contractNumberRes}
                                                   min={0}
                                                />
                                            </Col>
                                        </Row>
                                        <div className={"text-center mt-2"}>
                                            { nationalIdSearchRes && contractNumberRes ?
                                                ...
                                                : nationalIdSearchRes && firstNameSearchRes && lastNameSearchRes ?
                                                    <Btn attrBtn={{color: 'primary', disabled: true}}>فقط یک نوع فیلد را جستجو کنید</Btn>
                                                    : contractNumberRes && firstNameSearchRes && lastNameSearchRes ?
                                                        <Btn attrBtn={{color: 'primary', disabled: true}}>فقط یک نوع فیلد را جستجو کنید</Btn>
                                                            ...
                                                            : firstNameSearchRes && !lastNameSearchRes ?
                                                                ...
                                                                : firstNameSearchRes && lastNameSearchRes ?
                                                                    ...
                                                                    : nationalIdSearchRes ?
                                                                        ...
                                                                        : contractNumberRes ?
                                                                            <Btn attrBtn={{ color: 'primary', onClick: (e) => handleGetContractNumber(e, contractNumberRes) }} >جستجو</Btn>
                                                                            :
...
export default ReceiveTheDeathFileAccordion;