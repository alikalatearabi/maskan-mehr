      ...
      <Form>
        <FormGroup className=" m-form__group">
          ...
          <InputGroup>
            ...
            <Input className="form-control input-air-primary" type="text" placeholder="Email" />
          </InputGroup>
        </FormGroup>
        <FormGroup className="">
          <Label>{RightAddon}</Label>
          <InputGroup>
            <Input className="form-control input-air-primary" type="text" placeholder="Recipient's username" aria-label="Recipient's username" />
        ...
        <FormGroup className="">
          ...
          <InputGroup>
            ...
            <Input className="form-control input-air-primary" type="text" aria-label="Amount (to the nearest dollar)" />
          </InputGroup>
        </FormGroup>
        <FormGroup className="">
        ...
        <FormGroup className=" input-group-solid">
          ...
          <InputGroup>
            ...
            <Input className="form-control input-air-primary" type="text" placeholder="999999" />
          </InputGroup>
        </FormGroup>
        <FormGroup className=" input-group-square">
          ...
          <InputGroup>
            ...
            <Input className="form-control input-air-primary" type="text" placeholder="" />
          </InputGroup>
        </FormGroup>
        <FormGroup className=" input-group-square">
