      ...
      <Form className="needs-validation" noValidate="" onSubmit={handleSubmit(onSubmit)}>
        <Row>
          ...
          <Col md="4 mb-3">
            ...
            <InputGroup>
              ...
              {/* </InputGroupAddon> */}
              <input className="form-control input-air-primary" name="userName" type="text" placeholder="Username" {...register('userName', { required: true })} />
        ...
        <Row>
          ...
          <Col md="3 mb-3">
            ...
            <input className="form-control input-air-primary" id="validationCustom04" name="state" type="text" placeholder="State" {...register('state', { required: true })} />
            <span>{errors.state && 'Please provide a valid state.'}</span>
            <div className="invalid-feedback">{'Please provide a valid state.'}</div>
          </Col>
          <Col md="3 mb-3">
            <Label htmlFor="validationCustom05">Zip</Label>
            <input className="form-control input-air-primary" id="validationCustom05" name="zip" type="text" placeholder="Zip" {...register('zip', { required: true })} />
