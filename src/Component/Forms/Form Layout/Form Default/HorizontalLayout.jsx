      ...
      <CardBody>
        <Form className="theme-form">
          <FormGroup className="row">
            ...
            <Col sm="9">
              <Input className="form-control input-air-primary" type="email" placeholder="Email" />
            </Col>
          </FormGroup>
          <FormGroup className="row">
          ...
          <FormGroup className="row">
            ...
            <Col sm="9">
              <Input className="form-control input-air-primary" type="number" placeholder="Contact" />
            </Col>
          </FormGroup>
          <FormGroup className="row">
          ...
          <FormGroup className="row">
            ...
            <Col sm="9">
              <Input className="form-control input-air-primary" type="url" placeholder="Website" />
            </Col>
          </FormGroup>
