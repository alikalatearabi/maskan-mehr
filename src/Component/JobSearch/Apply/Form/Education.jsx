        ...
        <Row>
          <Col xl="6 xl-100">
            <FormGroup>
              ...
              <Input className="form-control input-air-primary" id="exampleFormControlInput5" type="email" placeholder="Enter college name" />
            </FormGroup>
          </Col>
          <Col xl="6 xl-100">
          ...
          <Col lg="6">
            <FormGroup>
              ...
              <Input className="form-control input-air-primary" id="exampleFormControlInput6" type="email" placeholder="Enter specialization" />
            </FormGroup>
          </Col>
        </Row>
      </Form>
