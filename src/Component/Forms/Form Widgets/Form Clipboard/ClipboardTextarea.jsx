          ...
          <Card>
            ...
            <CardBody >
              <div className="clipboaard-container">
                ...
                <Input className="form-control input-air-primary" id="clipboardExample2" type="textarea" rows="1" spellCheck="false" value={state.value} onChange={({ target: { value } }) => setState({ value, copied: false })}></Input>
                <div className="mt-3">
