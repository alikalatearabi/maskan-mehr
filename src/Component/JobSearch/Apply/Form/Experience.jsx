        ...
        <Row>
          <Col xl="6 xl-100">
            <FormGroup>
              ...
              <Input className="form-control input-air-primary" id="exampleFormControlInput7" type="email" placeholder="Enter Location" />
            </FormGroup>
          </Col>
          <Col xl="6 xl-100">
          ...
          <Col xl="6 xl-100">
            <FormGroup>
              ...
              <Input className="form-control input-air-primary" id="exampleFormControlInput8" type="email" placeholder="Enter Company Name" />
            </FormGroup>
          </Col>
        </Row>
      </Form>
