    ...
    <CommonModal isOpen={modal} title={NewMessage} toggler={toggle} >
      <Form>
        <FormGroup>
          ...
          <Input className="form-control input-air-primary" type="text" defaultValue={defaultVal} />
        </FormGroup>
        <FormGroup>
          <Label className="col-form-label" for="message-text">{'Message:'}</Label>
          <Input type="textarea" className="form-control input-air-primary" id="message-text"></Input>
        </FormGroup>
      </Form>
    </CommonModal>
