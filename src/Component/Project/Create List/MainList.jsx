...
const MainList = () => {
    ...
    const AddProject = data => {
        addNewProject(data);
        history(`${process.env.PUBLIC_URL}/project/projectlist`);
    };
    return (
        <Fragment>
                ...
                <Row>
                    <Col>
                        <div className="mb-3">
                            ...
                            <input type="textarea" className="form-control input-air-primary" name="description" rows="3" style={{ height: '80px' }} {...register('description', { required: true })} />
