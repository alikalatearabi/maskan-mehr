...
const Layout = ({children, classNames, ...rest}) => {
    const {
        sidebar_types, settings, toggleIcon, setToggleIcon, defaultClass, setDefaultClass
    ...
    return (
        <Fragment>
            <Loader/>
            <TapTop/>
            <div className={`page-wrapper ${!defaultClass ? sidebar_types1 : 'compact-wrapper'} ${settings1}`}
                 id="pageWrapper">
                ...
                <div className="page-body-wrapper">
                    <div className={`sidebar-wrapper ${toggleIcon ? 'close_icon' : ''}`}>
                        ...
                        <a
                            ...
                            href={'https://dl.maskanins.ir/files/Mehr%20Manual.pdf'}
                        >
                            دانلود راهنما
                        </a>
                    </div>
