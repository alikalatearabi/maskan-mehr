...
const UploadFileContract = ({idTracking, title, itemId, keyOp, UploadedFileAppointmentDocument}) => {
    ...
    const handledUploadFile = async (e) => {
        ...
        formData.append('UploadedFileAppointmentDocument', parseInt(UploadedFileAppointmentDocument));
    ...
    const getIdFileStatus = () => {
        axios.post("/DeceasedDocument/GetDeceasedDocumentAppointmentFile", JSON.stringify(
                {
                    "deceasedDocumentId": parseInt(itemId),
                    "deceasedDocumentAppointmentFiles": parseInt(keyOp)
                }
            ),
            {
                headers: {
...
export default UploadFileContract;