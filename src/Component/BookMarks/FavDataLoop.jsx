...
const FavDataLoop = () => {
  ...
  return (
    <Fragment>
      <Row>
        {mybookmarkData.length > 0 ? (mybookmarkData.map((mybookdata) => {
          return (
                ...
                <div className="details-website">
                  ...
                  <div className="desciption-data">
                    <div className="title-bookmark"><H6 attrH6={{ className: 'title_0' }}>{mybookdata.title}
                      ...
                      <div className="content-general"><P attrPara={{ className: 'desc_3' }}>{mybookdata.desc}</P>
                        <span className="collection_3">{mybookdata.collection}</span>
                      </div>
                    </div>
                  </div>
                </div>
